...
// Wording of the consent checkbox on the page. Bump the version when the text changes.
export const CONSENT_TEXT = 'Send me my results and occasional tips from iExcel.';
export const CONSENT_TEXT_VERSION = 'gdg-2026-09';
